...
public interface SchoolValidators extends AbstractValidator<SchoolRequestApiDto> {
    ...
    String EXCEPTION_MESSAGE_SCHOOL_ALREADY_EXIST = "school.already.exists";
    String EXCEPTION_MESSAGE_SCHOOL_WITH_NIP_ALREADY_EXIST = "school.with.nip.already.exists";
    String EXCEPTION_MESSAGE_SCHOOL_WITH_REGON_ALREADY_EXIST = "school.with.regon.already.exists";
