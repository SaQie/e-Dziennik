...
public class StudentResponseApiDto{
    ...
    public StudentResponseApiDto(Long id,String username, String firstName, String lastName, String adress, String postalCode, String city, String pesel, String parentFirstName, String parentLastName, String parentPhoneNumber, Long idSchool, Long idSchoolClass) {
        this.id = id;
