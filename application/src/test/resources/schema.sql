...
values (gen_random_uuid(), 'UNIVERSITY', 1);
INSERT INTO school_level(id, name, version)
values (gen_random_uuid(), 'PRIMARY', 1);
INSERT INTO school_level(id, name, version)
values (gen_random_uuid(), 'HIGH', 1);

INSERT INTO role(id, name, version)
VALUES (gen_random_uuid(), 'ROLE_ADMIN', 1);
INSERT INTO role(id, name, version)
VALUES (gen_random_uuid(), 'ROLE_STUDENT', 1);
INSERT INTO role(id, name, version)
